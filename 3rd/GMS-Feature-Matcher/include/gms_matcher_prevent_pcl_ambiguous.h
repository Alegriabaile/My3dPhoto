...
#ifndef MY3DPHOTO_GMS_MATCHER_PREVENT_PCL_AMBIGUOUS_H
#define MY3DPHOTO_GMS_MATCHER_PREVENT_PCL_AMBIGUOUS_H
...
// 5 level scales
    ...
    {
    public:
        // OpenCV Keypoints & Correspond Image cv::Size & Nearest Neighbor Matches 
    ...
    public:
        ...
        int GetInlierMask(std::vector<bool> &vbInliers, bool WithScale = true, bool WithRotation = false);
    ...
    private:
        ...
        // Convert OpenCV cv::DMatch to Match (pair<int, int>)
    ...
    void gms_matcher::VerifyCellPairs(int RotationType) {
        ...
        for (int i = 0; i < mGridNumberLeft; i++)
        {
            ...
            thresh = THRESH_FACTOR_M3D * sqrt(thresh / numpair);
...
#endif //MY3DPHOTO_GMS_MATCHER_PREVENT_PCL_AMBIGUOUS_H
